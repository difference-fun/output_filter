...
namespace Package\Difference\Fun\Output\Filter\Controller;
...
class Cli extends Controller {
    ...
    const INFO = [
        '{{binary()}} difference_fun/output_filter           | Output filter options',
        '{{binary()}} difference_fun/output_filter setup     | Output filter setup',
    ];
